...
const socket = io.connect('http://192.168.18.45:3000'); //client establishes websocket connection to server
...
var simon_startquit_btn= document.getElementById('simon-startquit');
...
document.getElementById('submit-msg').onclick = () => {
